          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <p className="text-lg md:text-xl font-light text-gray-700 leading-relaxed">
                With our parent company Brown Paper, we specialize in comprehensive event branding solutions that help create a cohesive and impactful identity for your events. From customized banners and signage to branded backdrops and promotional materials, our team works closely with you to design elements that reflect your brand&apos;s essence.
              </p>
              <p className="text-lg md:text-xl font-light text-gray-700 leading-relaxed">
                Our goal is to enhance visibility and recognition, ensuring that your event stands out and leaves a lasting impression on attendees. With attention to detail and a focus on quality, we bring your vision to life, making your event not just memorable, but truly distinctive.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
            ...
            >
              <h3 className="text-2xl md:text-3xl font-normal text-gray-900 mb-6">What We Offer</h3>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="w-1 h-1 rounded-full bg-primary mt-2 flex-shrink-0" />
                  <span className="text-gray-600 font-light leading-relaxed text-base md:text-lg">Customized banners and signage</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-1 h-1 rounded-full bg-primary mt-2 flex-shrink-0" />
                  <span className="text-gray-600 font-light leading-relaxed text-base md:text-lg">Branded backdrops and displays</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-1 h-1 rounded-full bg-primary mt-2 flex-shrink-0" />
                  <span className="text-gray-600 font-light leading-relaxed text-base md:text-lg">Promotional materials</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-1 h-1 rounded-full bg-primary mt-2 flex-shrink-0" />
                  <span className="text-gray-600 font-light leading-relaxed text-base md:text-lg">Complete brand identity solutions</span>
                </li>
              </ul>
            </motion.div>
          </div>
      ...
      <section className="py-24 md:py-32 px-6 md:px-12 bg-gradient-to-b from-gray-50/30 via-white to-gray-50/30 relative overflow-hidden">
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          >
            ...
            >
              Get a quote for your event branding needs today and create a distinctive identity for your event.
            </motion.p>
