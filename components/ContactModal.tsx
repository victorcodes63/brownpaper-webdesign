...
export default function ContactModal({ isOpen, onClose }: ContactModalProps) {
  ...
  // Prevent body scroll when modal is open (Lenis + native overflow)
  useEffect(() => {
    if (isOpen) {
      lenis?.stop()
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-start sm:items-center justify-between p-4 sm:p-6 md:p-8 border-b border-gray-100">
                  ...
                  <motion.button
                    ...
                    className="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center hover:bg-gray-100 transition-colors text-gray-400 hover:text-gray-900 disabled:opacity-50 shrink-0"
                  >
                ...
                <form onSubmit={handleSubmit} className="p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-6">
                  ...
                  >
                    ...
                    <input
                      ...
                      className="w-full px-4 sm:px-6 py-3 sm:py-4 bg-white border-2 border-gray-200 rounded-xl font-light focus:border-primary focus:outline-hidden transition-all text-base"
                      required
                      disabled={isSubmitting}
                    />
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full px-4 sm:px-6 py-3 sm:py-4 bg-white border-2 border-gray-200 rounded-xl font-light focus:border-primary focus:outline-hidden transition-all appearance-none cursor-pointer pr-10 sm:pr-12 text-base text-gray-900 min-h-[44px]"
                        style={{
                  ...
                  >
                    ...
                    <textarea
                      ...
                      className="w-full px-4 sm:px-6 py-3 sm:py-4 bg-white border-2 border-gray-200 rounded-xl font-light focus:border-primary focus:outline-hidden transition-all resize-none text-base"
                      required
                      disabled={isSubmitting}
                    />
                  </motion.div>
